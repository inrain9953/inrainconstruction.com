...
const ModularGorakhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-gorakhpur";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-gorakhpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Gorakhpur" />
      <Footer />
    </>
  );
};

export default ModularGorakhpur;
