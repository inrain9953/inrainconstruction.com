...
const ModularPanipat = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-panipat";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-panipat";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Panipat" />
      <Footer />
    </>
  );
};

export default ModularPanipat;
