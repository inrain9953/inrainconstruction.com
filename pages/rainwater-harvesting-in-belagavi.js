...
const RainwaterBelagavi = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-belagavi";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-belagavi";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Belagavi"} />
      <Footer />
    </>
  );
};

export default RainwaterBelagavi;
