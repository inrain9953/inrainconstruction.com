...
const RainwaterAgartala = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-agartala";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-agartala";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Agartala"} />
      <Footer />
    </>
  );
};

export default RainwaterAgartala;
