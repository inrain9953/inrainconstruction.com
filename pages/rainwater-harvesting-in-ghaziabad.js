...
const RainwaterGhaziabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-ghaziabad";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-ghaziabad";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Ghaziabad"} />
      <Footer />
    </>
  );
};

export default RainwaterGhaziabad;
