...
const RainwaterAmritsar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-amritsar";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-amritsar";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Amritsar"} />
      <Footer />
    </>
  );
};

export default RainwaterAmritsar;
