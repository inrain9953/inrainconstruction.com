...
const PolymerTypeMangaluru = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-mangaluru";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-mangaluru";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Mangaluru"} />
      <Footer />
    </>
  );
};

export default PolymerTypeMangaluru;
