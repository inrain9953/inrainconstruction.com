...
const PolymerTypeGorakhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-gorakhpur";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-gorakhpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Gorakhpur"} />
      <Footer />
    </>
  );
};

export default PolymerTypeGorakhpur;
