...
const RainwaterJalandhar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jalandhar";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jalandhar";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Jalandhar"} />
      <Footer />
    </>
  );
};

export default RainwaterJalandhar;
