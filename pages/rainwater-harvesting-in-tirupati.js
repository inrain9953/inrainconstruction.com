...
const RainwaterTirupati = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-tirupati";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-tirupati";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Tirupati"} />
      <Footer />
    </>
  );
};

export default RainwaterTirupati;
