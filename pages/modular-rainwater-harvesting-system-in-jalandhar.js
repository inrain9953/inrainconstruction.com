...
const ModularJalandhar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-jalandhar";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-jalandhar";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Jalandhar" />
      <Footer />
    </>
  );
};

export default ModularJalandhar;
