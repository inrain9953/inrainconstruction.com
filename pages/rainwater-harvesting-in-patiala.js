...
const RainwaterPatiala = () => {
  ...
  const keyword = `Rainwater Harvesting in ${loc}, Rooftop Rainwater Harvesting in ${loc}, Modular Rainwater Harvesting System in ${loc}, Rainwater Harvesting Tank in ${loc}, Groundwater Recharge`;
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-patiala";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-patiala";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Patiala"} />
      <Footer />
    </>
  );
};

export default RainwaterPatiala;
