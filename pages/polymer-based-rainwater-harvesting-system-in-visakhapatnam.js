...
const PolymerTypeVisakhapatnam = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-visakhapatnam";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-visakhapatnam";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Visakhapatnam"} />
      <Footer />
    </>
  );
};

export default PolymerTypeVisakhapatnam;
