...
const PolymerTypeGhaziabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-ghaziabad";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-ghaziabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Ghaziabad"} />
      <Footer />
    </>
  );
};

export default PolymerTypeGhaziabad;
