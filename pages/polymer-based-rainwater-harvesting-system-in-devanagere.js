...
const PolymerTypeDevanagere = () => {
  const loc = "Devanagere";
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-devanagere";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-devanagere";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Devanagere"} />
      <Footer />
    </>
  );
};

export default PolymerTypeDevanagere;
