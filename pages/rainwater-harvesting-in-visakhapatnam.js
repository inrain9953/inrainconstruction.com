...
const RainwaterVisakhapatnam = () => {
  const loc = "Visakhapatnam";
  ...
  const keyword = `Rainwater Harvesting System in ${loc}, Rooftop Rainwater Harvesting System in ${loc}, Modular Rainwater Harvesting System in ${loc}, Rainwater Harvesting Tank in ${loc}, Groundwater Recharge in ${loc}`;
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-visakhapatnam";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-visakhapatnam";
  ...
  const twittertitle = `Rainwater Harvesting System in ${loc} | Rooftop Rainwater Harvesting System in ${loc} | InRain® Construction Pvt. Ltd.`;
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Visakhapatnam"} />
      <Footer />
    </>
  );
};

export default RainwaterVisakhapatnam;
