...
const PolymerTypeDharamshala = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-dharamshala";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-dharamshala";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Dharamshala"} />
      <Footer />
    </>
  );
};

export default PolymerTypeDharamshala;
