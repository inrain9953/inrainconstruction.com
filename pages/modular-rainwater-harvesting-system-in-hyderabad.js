...
const ModularHyderabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-hyderabad";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-hyderabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Hyderabad" />
      <Footer />
    </>
  );
};

export default ModularHyderabad;
