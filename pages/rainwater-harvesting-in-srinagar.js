...
const RainwaterSrinagar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-srinagar";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-srinagar";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Srinagar"} />
      <Footer />
    </>
  );
};

export default RainwaterSrinagar;
