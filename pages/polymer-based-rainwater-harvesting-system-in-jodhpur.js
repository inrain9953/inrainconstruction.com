...
const PolymerTypeJodhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-jodhpur";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-jodhpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Jodhpur"} />
      <Footer />
    </>
  );
};

export default PolymerTypeJodhpur;
