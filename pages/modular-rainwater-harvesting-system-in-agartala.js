...
const ModularAgartala = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-agartala";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-agartala";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Agartala" />
      <Footer />
    </>
  );
};

export default ModularAgartala;
