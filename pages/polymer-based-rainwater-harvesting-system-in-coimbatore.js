...
const PolymerTypeCoimbatore = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-coimbatore";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-coimbatore";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Coimbatore"} />
      <Footer />
    </>
  );
};

export default PolymerTypeCoimbatore;
