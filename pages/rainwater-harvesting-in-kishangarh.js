...
const RainwaterKishangarh = () => {
  const loc = "Kishangarh";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-kishangarh";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-kishangarh";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Kishangarh"} />
      <Footer />
    </>
  );
};

export default RainwaterKishangarh;
