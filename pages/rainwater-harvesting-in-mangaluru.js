...
const RainwaterMangaluru = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-mangaluru";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-mangaluru";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Mangaluru"} />
      <Footer />
    </>
  );
};

export default RainwaterMangaluru;
