...
const RainwaterJabalpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jabalpur";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jabalpur";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Jabalpur"} />
      <Footer />
    </>
  );
};

export default RainwaterJabalpur;
