...
const PolymerTypeHyderabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-hyderabad";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-hyderabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Hyderabad"} />
      <Footer />
    </>
  );
};

export default PolymerTypeHyderabad;
