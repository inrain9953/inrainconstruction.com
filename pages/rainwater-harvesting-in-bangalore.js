...
const RainwaterBangalore = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bangalore";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bangalore";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Bangalore"} />
      <Footer />
    </>
  );
};

export default RainwaterBangalore;
