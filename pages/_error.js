...
const _error = () => {
  return (
    ...
    <div className="md:m-5 m-2 rounded-lg shadow-xl p-5">
        ...
        <div className="mt-5">
          <h2 className="text-lg font-semibold md:text-xl text-center">Oops! Page Not Found (404)</h2>
        ...
        <div className="mt-5 md:text-center">
          <h3 className="text-lg md:text-2xl font-semibold">Here's what you can do:</h3>
        ...
        <div className="mt-5 text-center">
          <h4 className="text-2xl font-semibold text-sky-500"> Let’s make every drop count!</h4>
        </div>
      </div>
