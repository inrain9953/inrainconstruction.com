...
const RainwaterBhagalpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bhagalpur";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bhagalpur";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Bhagalpur"} />
      <Footer />
    </>
  );
};

export default RainwaterBhagalpur;
