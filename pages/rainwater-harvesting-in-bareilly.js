...
const RainwaterBareilly = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bareilly";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bareilly";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Bareilly"} />
      <Footer />
    </>
  );
};

export default RainwaterBareilly;
