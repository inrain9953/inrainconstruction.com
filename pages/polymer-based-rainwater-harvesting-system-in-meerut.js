...
const PolymerTypeMeerut = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-meerut";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-meerut";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Meerut"} />
      <Footer />
    </>
  );
};

export default PolymerTypeMeerut;
