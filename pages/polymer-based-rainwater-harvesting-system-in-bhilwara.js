...
const PolymerTypeBhilwara = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-bhilwara";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-bhilwara";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Bhilwara"} />
      <Footer />
    </>
  );
};

export default PolymerTypeBhilwara;
