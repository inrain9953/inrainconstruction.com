...
const RainwaterGorakhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-gorakhpur";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-gorakhpur";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Gorakhpur"} />
      <Footer />
    </>
  );
};

export default RainwaterGorakhpur;
