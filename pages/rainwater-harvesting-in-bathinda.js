...
const RainwaterBathinda = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bathinda";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bathinda";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Bathinda"} />
      <Footer />
    </>
  );
};

export default RainwaterBathinda;
