...
const RainwaterBhilwara = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bhilwara";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bhilwara";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Bhilwara"} />
      <Footer />
    </>
  );
};

export default RainwaterBhilwara;
