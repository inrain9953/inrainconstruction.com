...
const ModularSolapur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-solapur";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-solapur";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Solapur" />
      <Footer />
    </>
  );
};

export default ModularSolapur;
