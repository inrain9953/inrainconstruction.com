...
const RainwaterVadodara = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-vadodara";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-vadodara";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Vadodara"} />
      <Footer />
    </>
  );
};

export default RainwaterVadodara;
