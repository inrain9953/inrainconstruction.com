...
const RainwaterGreaterNoida = () => {
  const loc = "Greater Noida";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-greater-noida";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-greater-noida";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Greater Noida"} />
      <Footer />
    </>
  );
};

export default RainwaterGreaterNoida;
