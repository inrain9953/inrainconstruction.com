...
const PolymerTypeBhubaneswar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-bhubaneswar";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-bhubaneswar";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Bhubaneswar"} />
      <Footer />
    </>
  );
};

export default PolymerTypeBhubaneswar;
