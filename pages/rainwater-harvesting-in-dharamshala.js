...
const RainwaterDharamshala = () => {
  const loc = "Dharamshala";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-dharamshala";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-dharamshala";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Dharamshala"} />
      <Footer />
    </>
  );
};

export default RainwaterDharamshala;
