...
const RainwaterDehradun = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-dehradun";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-dehradun";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Dehradun"} />
      <Footer />
    </>
  );
};

export default RainwaterDehradun;
