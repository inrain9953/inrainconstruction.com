...
const PolymerTypeChandigarh = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-chandigarh";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-chandigarh";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Chandigarh"} />
      <Footer />
    </>
  );
};

export default PolymerTypeChandigarh;
