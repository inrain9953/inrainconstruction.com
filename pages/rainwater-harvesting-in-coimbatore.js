...
const RainwaterCoimbatore = () => {
  const loc = "Coimbatore";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-coimbatore";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-coimbatore";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Coimbatore"} />
      <Footer />
    </>
  );
};

export default RainwaterCoimbatore;
