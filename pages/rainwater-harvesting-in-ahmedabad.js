...
const RainwaterAhmedabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-ahmedabad";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-ahmedabad";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Ahmedabad"} />
      <Footer />
    </>
  );
};

export default RainwaterAhmedabad;
