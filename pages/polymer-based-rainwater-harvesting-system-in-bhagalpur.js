...
const PolymerTypeBhagalpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-bhagalpur";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-bhagalpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Bhagalpur"} />
      <Footer />
    </>
  );
};

export default PolymerTypeBhagalpur;
