...
const PolymerTypeJaisalmer = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-jaisalmer";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-jaisalmer";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Jaisalmer"} />
      <Footer />
    </>
  );
};

export default PolymerTypeJaisalmer;
