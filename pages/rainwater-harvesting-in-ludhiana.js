...
const RainwaterLudhiana = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-ludhiana";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-ludhiana";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Ludhiana"} />
      <Footer />
    </>
  );
};

export default RainwaterLudhiana;
