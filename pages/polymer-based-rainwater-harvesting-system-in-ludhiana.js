...
const PolymerTypeLudhiana = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-ludhiana";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-ludhiana";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Ludhiana"} />
      <Footer />
    </>
  );
};

export default PolymerTypeLudhiana;
