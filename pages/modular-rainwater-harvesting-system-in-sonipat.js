...
const ModularSonipat = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-sonipat";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-sonipat";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Sonipat" />
      <Footer />
    </>
  );
};

export default ModularSonipat;
