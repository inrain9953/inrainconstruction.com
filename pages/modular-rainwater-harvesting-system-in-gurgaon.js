...
const ModularGurgaon = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-gurgaon";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-gurgaon";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Gurgaon" />
      <Footer />
    </>
  );
};

export default ModularGurgaon;
