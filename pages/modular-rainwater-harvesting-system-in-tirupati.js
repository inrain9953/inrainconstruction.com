...
const ModularTirupati = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-tirupati";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-tirupati";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Tirupati" />
      <Footer />
    </>
  );
};

export default ModularTirupati;
