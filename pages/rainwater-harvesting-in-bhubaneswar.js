...
const RainwaterBhubaneswar = () => {
  const loc = "Bhubaneswar";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bhubaneswar";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-bhubaneswar";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Bhubaneswar"} />
      <Footer />
    </>
  );
};

export default RainwaterBhubaneswar;
