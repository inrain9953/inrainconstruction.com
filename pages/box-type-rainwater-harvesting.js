...
const Service8 = () => {
  const title =
    "Box Type Rainwater Harvesting | InRain® Construction Pvt. Ltd.";
  const desc =
        ...
        <div className="m-5 md:grid md:grid-cols-2 md:gap-10 md:items-center">
          <div data-aos="zoom-in-up" className="text-left">
            ...
            <p className="text-[17px] md:text-lg mt-3">
              ...
              various methods of rainwater harvesting systems Box Type Rainwater
              Harvesting is one that helps you in saving the mains water. Since
              in this methodology rainwater collected from the roof doesn’t go
              through rigorous filtration and purification, it is majorly suited
              for outdoor activities like car washing and watering your garden
              area. The rainwater stored through this method can also be
              utilised for laundry and flushing the toilet.Inrain Construction
              Pvt. Ltd, a water conservation and management company is one of
              the leading water conservation and management service providers.
              We are well known to provide technology-based modern solutions
              that fit today’s requirements. We are the top most rainwater
              harvesting vendors in Delhi-Gurgaon. We completely understand the
              challenges of the modern-day industries and housing societies.
              Therefore, we offer technologically advanced but cost-effective
              solutions for water conservation needs. <br></br>
              <br></br>
