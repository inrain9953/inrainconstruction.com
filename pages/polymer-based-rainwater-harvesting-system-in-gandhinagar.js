...
const PolymerTypeGandhinagar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-gandhinagar";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-gandhinagar";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Gandhinagar"} />
      <Footer />
    </>
  );
};

export default PolymerTypeGandhinagar;
