...
const PolymerTypeMuzaffarnagar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-muzaffarnagar";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-muzaffarnagar";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Muzaffarnagar"} />
      <Footer />
    </>
  );
};

export default PolymerTypeMuzaffarnagar;
