...
const PolymerTypeAhmedabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-ahmedabad";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-ahmedabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Ahmedabad"} />
      <Footer />
    </>
  );
};

export default PolymerTypeAhmedabad;
