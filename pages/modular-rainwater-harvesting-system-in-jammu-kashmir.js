...
const ModularJammuKashmir = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-jammu-kashmir";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-jammu-kashmir";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Jammu & Kashmir" />
      <Footer />
    </>
  );
};
