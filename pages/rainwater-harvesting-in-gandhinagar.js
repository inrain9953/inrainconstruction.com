...
const RainwaterGandhinagar = () => {
  const loc = "Gandhinagar";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-gandhinagar";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-gandhinagar";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Gandhinagar"} />
      <Footer />
    </>
  );
};

export default RainwaterGandhinagar;
