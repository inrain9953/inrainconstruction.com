...
const RainwaterChandigarh = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-chandigarh";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-chandigarh";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Chandigarh"} />
      <Footer />
    </>
  );
};

export default RainwaterChandigarh;
