...
const RainwaterJaisalmer = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jaisalmer";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jaisalmer";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Jaisalmer"} />
      <Footer />
    </>
  );
};

export default RainwaterJaisalmer;
