...
const ModularBhilwara = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-bhilwara";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-bhilwara";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Bhilwara" />
      <Footer />
    </>
  );
};

export default ModularBhilwara;
