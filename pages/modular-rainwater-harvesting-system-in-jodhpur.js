...
const ModularJodhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-jodhpur";
  const ogUrl =
    "https://www.inrainconstruction.com/modular-rainwater-harvesting-system-in-jodhpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <ModularLocationTarget location="Jodhpur" />
      <Footer />
    </>
  );
};

export default ModularJodhpur;
