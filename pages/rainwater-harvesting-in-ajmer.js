...
const RainwaterAjmer = () => {
  ...
  const keyword = `Rainwater Harvesting in System ${loc}, Rooftop Rainwater Harvesting System in ${loc}, Modular Rainwater Harvesting System in ${loc}, Rainwater Harvesting Tank in ${loc}, Groundwater Recharge in ${loc}`;
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-Ajmer";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-Ajmer";
  ...
  const twittertitle = `Rainwater Harvesting in System ${loc} | Rooftop Rainwater Harvesting System in ${loc} | InRain® Construction Pvt. Ltd.`;
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Ajmer"} />
      <Footer />
    </>
  );
};

export default RainwaterAjmer;
