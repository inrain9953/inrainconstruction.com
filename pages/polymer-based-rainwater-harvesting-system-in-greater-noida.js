...
const PolymerTypeGreaterNoida = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-greater-noida";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-greater-noida";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Greater Noida"} />
      <Footer />
    </>
  );
};

export default PolymerTypeGreaterNoida;
