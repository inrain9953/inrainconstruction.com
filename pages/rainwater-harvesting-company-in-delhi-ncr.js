...
const RainwaterHarvestingCompany = () => {
  ...
  const title = `Rainwater Harvesting Company in Delhi(NCR) | Rainwater Harvesting System Service Provider in ${loc}`
  ...
  const keyword = `Rainwater Harvesting Company in Delhi(NCR), Rooftop Rainwater Harvesting Company in ${loc}, Modular Rainwater Harvesting Company in ${loc}, Rainwater Harvesting Tank in ${loc}, Polymer Type Rainwater Harvesting Company in ${loc}, Storm water Management in ${loc}`
  const canonical =
    'https://www.inrainconstruction.com/rainwater-harvesting-company-in-delhi-ncr'
  const ogUrl =
    'https://www.inrainconstruction.com/rainwater-harvesting-company-in-delhi-ncr'
  const ogTitle = `Rainwater Harvesting Company in Delhi(NCR) | Rainwater Harvesting System Service Provider in ${loc}`
  ...
  return (
    <>
      ...
      <div className='m-2 md:flex md:justify-center md:m-10 mt-20'>
        <div className='md:content-center md:p-10'>
      ...
      <div className='text-center pt-10 m-5 md:m-10'>
        ...
        <p className='text-md mt-7 text-gray-500 md:pl-36 md:pr-36 drop-shadow-md md:text-xl'>
      ...
      <div className='m-2 md:flex md:justify-center md:m-10 mt-20'>
        ...
        <div className='m-10 md:w-full flex justify-center items-center md:inline'>
          <Image
...
export default RainwaterHarvestingCompany
