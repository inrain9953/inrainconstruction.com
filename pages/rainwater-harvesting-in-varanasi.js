...
const RainwaterVaranasi = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-varanasi";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-varanasi";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Varanasi"} />
      <Footer />
    </>
  );
};

export default RainwaterVaranasi;
