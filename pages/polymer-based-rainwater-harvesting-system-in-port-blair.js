...
const PolymerTypePortBlair = () => {
  const loc = "Port Blair";
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-port-blair";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-port-blair";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Port Blair"} />
      <Footer />
    </>
  );
};

export default PolymerTypePortBlair;
