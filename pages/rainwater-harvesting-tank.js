...
const RWHTank = () => {
  ...
  return (
    <>
      ...
      <div class="max-w-4xl mx-auto p-6 text-gray-800 leading-relaxed">
        <h1 class="text-3xl font-bold text-justify mb-4">
        ...
        <div class="space-y-4">
          <div>
            <h3 class="font-semibold">✔️ Reliable Water Backup</h3>
          ...
          <div>
            <h3 class="font-semibold">✔️ Reduces Water Bills</h3>
            <p className="text-justify">
          ...
          <div>
            <h3 class="font-semibold">✔️ Supports Groundwater Recharge</h3>
            <p className="text-justify">
          ...
          <div>
            <h3 class="font-semibold">✔️ Promotes Eco-Friendly Living</h3>
            <p className="text-justify">
          ...
          <div>
            <h3 class="font-semibold">✔️ Long-Term Savings</h3>
            <p className="text-justify">
        ...
        <div class="space-y-6">
          <div>
            <h3 class="text-xl font-semibold">1. Surface Tanks</h3>
            <p className="text-justify">Above-ground tanks made from FRP, HDPE, plastic, or concrete.</p>
            <p class="font-medium">
          ...
          <div>
            <h3 class="text-xl font-semibold">2. Underground Tanks</h3>
            <p className="text-justify">
          ...
          <div>
            <h3 class="text-xl font-semibold">3. Modular Tanks</h3>
            <p className="text-justify">
        ...
        <p className="font-semibold mb-3">
          <a
            href="/contact-us"
            class="inline-block mr-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition"
          >
            Contact us
          </a>
