...
const RainwaterJammu = () => {
  const loc = "Jammu & Kashmir";
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jammu-kashmir";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-jammu-kashmir";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Jammu & Kashmir"} />
      <Footer />
    </>
  );
};

export default RainwaterJammu;
