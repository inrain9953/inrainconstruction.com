...
const RainwaterAllahabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-allahabad";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-allahabad";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Allahabad"} />
      <Footer />
    </>
  );
};

export default RainwaterAllahabad;
