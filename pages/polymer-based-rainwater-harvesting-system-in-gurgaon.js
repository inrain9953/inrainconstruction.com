...
const PolymerTypeGurgaon = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-gurgaon";
  const ogUrl =
    "https://www.inrainconstruction.com/polymer-based-rainwater-harvesting-system-in-gurgaon";
  ...
  return (
    <>
      ...
      <Navbar />
      <PopUp />
      <PolymerTypeLocationTarget location={"Gurgaon"} />
      <Footer />
    </>
  );
};

export default PolymerTypeGurgaon;
