...
const RainwaterFaridabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-faridabad";
  const ogUrl =
    "https://www.inrainconstruction.com/rainwater-harvesting-in-faridabad";
  ...
  return (
    <>
      ...
      <PopUp />
      <Hero1 />
      <LocationTarget location={"Faridabad"} />
      <Footer />
    </>
  );
};

export default RainwaterFaridabad;
