  ...
  return (
    <>
      ...
      <div className='m-5 md:grid md:grid-cols-1'>
        <div className='mt-5 pb-10 md:flex md:justify-center md:items-center md:gap-14'>
        ...
        <div className='mt-10 pb-10 md:flex md:justify-center md:items-center md:gap-14'>
